...
In plot 2, "Max Average Profit," we accounted for the building types and the maximum average profit by cluster. In order to create this plot, we assumed that all the green buildings paid for the utility costs of the tenant, to get an extremely conservative amount of profit for green buildings vs. non-green buildings. This allows us to conservatively compare the lower-end of profit landlords receive from green buildings compared to non-green buildings. Thus, the profit was calculated as: Rents received - total utility costs. Even with this conservative factor, the average profit by green buildings vastly outperformed the non-green buildings.
